const facts = [
  ...
  "Le mot chat dans différentes langues: Allemand: katze; Italien: gatto; Espagnol/Portugais: gato; Yiddish: kats; Maltais: qattus; Suèdois/Norvègien: katt; Hollandais: kat; Islandique: kottur; Grecques: catta; Hindou: katas; Japanais:neko; Polonais: kot; Ukranien: kotuk; Hawiien: popoki; Russe: koshka; Latin: cattus; Egyptien: mau; Turques: kedi; Armenien: Gatz; Chinois: mao; Arabe: biss; Indonesien: qitta; Bulgare: kotka; Malay: kucing; Thai/Vietnamien: meo; Roumain: pisica; Lithuanien: katinas; Tchèque: kocka; Slovaque: macka; Armenien: gatz; Basque: catua; Estonien: kass; Finlandais: kissa; Swahili: paka.",
