...
const facts = [
  ...
  "Slovo 'kočka' v různých jazycích: francouzština: chat; němčina: katze; italština: gatto; španělština/portugalština: gato; jidiš: kats; maltština: qattus; švédština/norština: katt; holandština: kat; islandština: kottur; řečtina: catta; hindi: katas; japonština: neko; polština: kot; ukrajinština: kotuk; havajština: popoki; ruština: koshka; latina: cattus; egyptštnia: mau; turečtina: kedi; arménština: gatz; čínština: mao; arabština: biss; indonéština: qitta; bularština: kotka; malajština: kucing; thajština/vietnamština: meo; rumunština: pisica; litevština: katinas; angličtina: cat; slovenština: macka; arménština: gatz; baskitština: catua; estonština: kass; finština: kissa; svahilština: paka.",
